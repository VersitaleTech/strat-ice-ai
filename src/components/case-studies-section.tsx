...
const caseStudies = [
  ...
  },
  {
    ...
    results: [
      ...
      "$250,000 additional annual revenue"
    ],
    image: "https://images.pexels.com/photos/1546168/pexels-photo-1546168.jpeg?auto=compress&cs=tinysrgb&w=600"
  },
  {
    industry: "E-commerce",
    company: "Aruba Island Gifts",
    challenge: "Limited customer support capacity during peak season, leading to abandoned carts and negative reviews",
    solution: "Created multilingual AI customer support for order tracking, product recommendations, and returns",
    results: [
